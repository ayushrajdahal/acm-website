...
class Timer extends React.Component<object, TimerState> {
  ...
  componentDidMount() {
    const targetDate = new Date("2025-01-28T23:00:00Z"); // 5 PM CST is 11 PM UTC
  ...
  render() {
    ...
    return (
      <div className="flex flex-col items-center justify-center mb-8 mt-16">
        <h2 className="text-5xl font-semibold mb-4">Vim Workshop Starts In</h2>
        ...
        <h3 className="text-l mb-6">
          You will be redirected to the Zoom meeting once the workshop begins.
        </h3>
      </div>
    );
  }
